...
# This program takes a simple input from user with numbers range 0-9 and will print out the english word of the input
# with a numerical output
...
if userInput[1] in operator:
    ...
    if len(userInput) == 3:
        ...
        elif userInput[2] not in numInt:
